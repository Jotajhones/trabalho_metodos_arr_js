import { includes, indexOf, some, every, find, findIndex, findLast, findLastIndex } from '../scripts/algorithms.js';
...
if (!Array.prototype.find) {
  Array.prototype.find = function(predicate) {
    ...
    {
        id: "findindex",
        nome: "Array.prototype.findIndex()",
        tipo: "Método de Instância",
        resumo: "Retorna o índice do primeiro elemento no array que passar na condição da função. Se nenhum passar, retorna -1. É a evolução semântica do indexOf para arrays de objetos.",
        sintaxe: "arr.findIndex(callback)",
        polyfill: `
if (!Array.prototype.findIndex) {
  Array.prototype.findIndex = function(predicate) {
    ...
    {
        id: "findlast",
        nome: "Array.prototype.findLast()",
        tipo: "Método de Instância",
        resumo: "Itera o array na ordem reversa (de trás para frente) e retorna o próprio elemento que satisfizer a função de teste. Excelente para evitar .reverse() mutando o array.",
        sintaxe: "arr.findLast(callback)",
        polyfill: `
if (!Array.prototype.findLast) {
  Array.prototype.findLast = function(predicate) {
    ...
    // O pulo do gato: Começa do último índice (len - 1)
    var k = len - 1;
    while (k >= 0) { // Vai descendo até o 0
      var kValue = o[k];
      if (predicate.call(thisArg, kValue, k, o)) {
        return kValue; // Retorna o valor
      }
      k--;
    }
    return undefined;
    ...
    {
        id: "findlastindex",
        nome: "Array.prototype.findLastIndex()",
        tipo: "Método de Instância",
        resumo: "Itera o array de trás para frente e retorna o índice do primeiro elemento encontrado que passe no teste. Combina a lógica do findIndex com a performance de busca reversa.",
        sintaxe: "arr.findLastIndex(callback)",
        polyfill: `
if (!Array.prototype.findLastIndex) {
  Array.prototype.findLastIndex = function(predicate) {
    ...
    while (k >= 0) {
      var kValue = o[k];
      if (predicate.call(thisArg, kValue, k, o)) {
        return k; // Retorna a posição (índice)
      }
      k--;
    }
    return -1;
